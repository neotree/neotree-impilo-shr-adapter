#!/usr/bin/env ts-node
/**
 * Generate a single test record without ID and save to JSON
 * Usage: npx ts-node scripts/generate-test-record.ts
 */
...
function generateTestRecord() {
  ...
  const startedAt = dobTob; // started_at should be equal to or just after DOBTOB
